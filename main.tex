...
% File chính: chứa preamble + trang bìa; nội dung từng chương nằm ở
% các file riêng trong thư mục chapters/ và được gọi bằng \input.
...
% Biên dịch bằng XeLaTeX (cần fontspec):  xelatex main.tex  (chạy 2 lần
% để mục lục hiện đúng số trang).
% ======================================================================
...
\hspace*{4.2cm} Nguyễn Phan Bảo Thi\\[4pt]
\hspace*{4.2cm} Nguyễn Hoàng Như\\[4pt]
\hspace*{4.2cm} Vũ Ngọc Anh Thư\\[4pt]
Lớp: 012012100202
\end{minipage}
\end{flushleft}
\vfill
...
\input{chapters/chuong6.tex}
\input{chapters/tailieuthamkhao.tex}
