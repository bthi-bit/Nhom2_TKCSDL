...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/phan_ra_3nf.png}
    \caption{Quá trình phân rã từ bảng BAO\_CAO\_SU\_KIEN đến các lược đồ 2NF và 3NF}
    \label{fig:phan-ra-3nf}
\end{figure}
